...
sim.reset(params.dt, params.winning_score, params.x0_ball, params.w_stdev, params.log, params.logname, 0, params.tau_puck, params.tau_player, params.player_mass, params.puck_mass)
